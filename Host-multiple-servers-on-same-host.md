The multiple server support is very basic and not intended for hosting a large amount of servers. But it is simple, and it works, and can be made smarter for those who cares about disk space.
